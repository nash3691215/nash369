    ...
    <div className="bg-white text-dark">
      ...
      <div className="border-b border-accent/20 bg-accent text-white">
        <div className="container-balanced py-3 text-center text-sm font-medium tracking-wide">
          🔥 Offre lancement : prix reduits pendant <strong>14 jours</strong>. Bundle <strong>59,90&euro;</strong> au lieu de <span className="line-through opacity-70">119,90&euro;</span>
        </div>
      </div>
      ...
      <header className="container-balanced pt-20 pb-16">
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl">
            Profite de <span className="highlight">l&apos;IA en 2026</span> pour optimiser ou lancer ton <span className="highlight-brand">business</span>
          </h1>
        ...
        <section className="bg-soft">
          <div className="container-balanced space-y-8">
            <div className="grid gap-8 lg:grid-cols-2">
              {leadMagnet.pillars.map((pillar, idx) => (
                <motion.div
                  key={pillar.title}
                ...
                >
                  ...
                  <ul className="space-y-3">
                    {pillar.points.map((point, pIdx) => (
                      <li key={pIdx} className="flex items-start gap-3 text-sm text-dark/75 leading-relaxed">
                        <span className={`mt-1 h-1.5 w-1.5 rounded-full shrink-0 ${idx === 0 ? "bg-brand/40" : "bg-accent/40"}`} />
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <a
                      href={AFFILIATE_LINKS[pillar.cta.link]}
                      target="_blank"
                      rel="noreferrer"
                      className={`inline-flex items-center justify-center rounded-full text-white px-5 py-2.5 text-sm font-semibold transition hover:translate-y-[-1px] active:translate-y-[0] ${
                        idx === 0 ? "bg-brand hover:bg-brand-light hover:shadow-glow-brand" : "bg-accent hover:bg-accent-dark hover:shadow-glow"
                      }`}
                    >
                    ...
                    {pillar.ctaSecondary && (
                      <a
                        href={AFFILIATE_LINKS[pillar.ctaSecondary.link]}
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center justify-center rounded-full border border-accent/20 text-accent px-5 py-2.5 text-sm font-semibold transition hover:border-accent/50 hover:bg-accent/5"
                      >
                        {pillar.ctaSecondary.label}
                      </a>
                    )}
                  </div>
                </motion.div>
        ...
        <section>
          <div className="container-balanced space-y-8">
            <div className="max-w-2xl mx-auto text-center space-y-3">
              ...
              <p className="text-base text-dark/60">
                Deux guides. Un objectif : lancer et automatiser ton business.
              </p>
            </div>
          ...
          <div className="container-balanced">
            <div className="grid gap-6 sm:grid-cols-3 text-center">
              <div className="space-y-2">
                ...
                <p className="text-sm font-bold text-dark">47 pages de contenu</p>
                <p className="text-xs text-dark/50">Deux guides pratiques, zero remplissage</p>
              </div>
              <div className="space-y-2">
                <span className="text-3xl block">🔒</span>
              ...
              <div className="space-y-2">
                <span className="text-3xl block">🔄</span>
                <p className="text-sm font-bold text-dark">Mises a jour incluses</p>
                <p className="text-xs text-dark/50">Nouvelles versions envoyees par email</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="container-balanced">
            <div className="max-w-2xl mx-auto text-center space-y-5">
              ...
              <p className="text-base text-dark/60">
                Prends le bundle et commence aujourd&apos;hui. Site + automatisation, tout est la.
              </p>
              <div className="space-y-2">
                <Button href={CTA_LINKS.EBOOK_BUNDLE_URL}>
                  Prendre le bundle (59,90&euro;)
                </Button>
                <p className="text-xs text-dark/40">
                  Economise 80&euro; par rapport a l&apos;achat separe
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-dark/10">
        <div className="container-balanced flex flex-col gap-4 py-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-sm text-dark/50">&copy; {new Date().getFullYear()} NASH369</div>
      ...
      <div className="fixed bottom-3 left-1/2 z-40 w-[calc(100%-1.5rem)] max-w-lg -translate-x-1/2 rounded-2xl border border-accent/20 bg-white/95 p-3 shadow-lg backdrop-blur sm:hidden">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs font-semibold text-dark">Bundle <span className="text-accent">59,90&euro;</span></p>
            <p className="text-[10px] text-dark/50 line-through">119,90&euro;</p>
          </div>
