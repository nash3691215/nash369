    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
              <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                ...
                <div className="text-gray-600 text-sm">Entrepreneurs formés</div>
              </div>
              <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-purple-600 mb-2">24/7</div>
                <div className="text-gray-600 text-sm">Systèmes autonomes</div>
              </div>
              <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                <div className="text-4xl font-bold text-pink-600 mb-2">ROI x10</div>
            ...
            {/* Lead Magnet CTA */}
            {leadMagnet && (
              <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-1 max-w-2xl mx-auto mb-8 shadow-2xl shadow-indigo-500/20">
                <div className="bg-white rounded-xl p-8">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <span className="text-4xl">⚡</span>
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Débloque tes premiers {leadMagnet.name}</h3>
                  </div>
                  <p className="text-gray-600 mb-6 text-lg">{leadMagnet.description}</p>
                  <Link
                    href="/prompts"
                    className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white px-10 py-5 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg shadow-indigo-600/30"
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 bg-red-50 border border-red-200 rounded-2xl p-8">
                <div className="text-red-600 text-sm font-bold uppercase tracking-wider">Le problème</div>
              ...
              <div className="space-y-6 bg-green-50 border border-green-200 rounded-2xl p-8">
                <div className="text-green-600 text-sm font-bold uppercase tracking-wider">La solution</div>
                <h2 className="text-4xl font-bold leading-tight text-gray-900">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-4 text-gray-900">Mes Systèmes Prêts à l'Emploi</h2>
            <p className="text-xl text-gray-600">Choisis ton arme pour générer du cash</p>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">Ils ont lancé leurs systèmes</h2>
      ...
      <section className="py-24 bg-gradient-to-br from-indigo-600 to-purple-700">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-bold mb-6 text-white">Prêt à construire ton système ?</h2>
