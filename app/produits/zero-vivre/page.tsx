              ...
              <div className="glass-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm">SB</div>
                    <div>
                      <div className="font-bold text-slate-900">Sophie B.</div>
                      <div className="text-xs text-slate-500 uppercase tracking-wider">ex-RH devenue créatrice</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:sticky lg:top-32">
              <div className="bg-white rounded-3xl shadow-2xl shadow-blue-900/10 border border-slate-200 p-8 overflow-hidden relative">
                ...
                <div className="mt-8 bg-slate-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-sm font-bold text-slate-800">🎁 Mises à jour à vie</p>
                </div>
