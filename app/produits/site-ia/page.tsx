        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white rounded-xl p-8 shadow-xl sticky top-8">
              ...
              <button onClick={() => createCheckoutSession('site-ia')} className="w-full bg-indigo-600 text-white py-4 rounded-lg font-semibold hover:bg-indigo-700 transition mb-4">
                Acheter Maintenant
              </button>
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-center"><span className="mr-2">🔒</span><span>Paiement sécurisé</span></div>
                <div className="flex items-center"><span className="mr-2">📥</span><span>Accès immédiat</span></div>
                <div className="flex items-center"><span className="mr-2">♾️</span><span>Accès à vie</span></div>
              </div>
            </div>
          </div>
        </div>
