          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-semibold text-gray-700">Formation complète</span>
              </div>
              <p className="text-gray-700 italic leading-relaxed">
                "J'ai monté mon site e-commerce en 24h avec Claude AI. Tout est automatique : paiement, livraison, emails."
              </p>
              <p className="text-sm text-gray-600 mt-2">— Thomas B., Créateur produits digitaux</p>
            </div>
          </div>
            ...
            <div className="bg-white border-2 border-gray-900 rounded-xl p-8 shadow-xl">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <p className="text-center text-sm text-gray-700">
                  <strong>🎁 Bonus:</strong> Code source complet + Analytics
                </p>
              </div>
            </div>
