    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-5xl">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-block px-3 py-1 bg-yellow-100 rounded-full text-sm font-bold text-yellow-800 mb-4">
            ⭐ BEST SELLER
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-semibold text-gray-700">+150 sites créés</span>
              </div>
              <p className="text-gray-700 italic leading-relaxed">
                "Mon site est en ligne depuis hier. 3 demandes de devis reçues ce matin. Formation claire et efficace."
              </p>
              <p className="text-sm text-gray-600 mt-2">— Sophie L., Coach bien-être</p>
            </div>
          </div>
            ...
            <div className="bg-white border-2 border-gray-900 rounded-xl p-8 shadow-xl">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <p className="text-center text-sm text-gray-700">
                  <strong>🎁 Bonus:</strong> Templates Next.js prêts à l'emploi
                </p>
              </div>
            </div>
